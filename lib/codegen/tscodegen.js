...
exports.isValidIdentifier =
  ...
  exports.createIntefaceAliasDeclaration =
  exports.createTypeAliasDeclaration =
  exports.createEnumTypeNode =
  exports.createLiteral =
  exports.modifier =
...
exports.keywordType = {
  ...
  void: typescript_1.factory.createKeywordTypeNode(
...
function createIntefaceAliasDeclaration({
  modifiers,
  name,
  typeParameters,
  type,
  ...
  const heritageClauses = inheritedNodeNames
    ? [
        typescript_1.factory.createHeritageClause(
          ...
          inheritedNodeNames.map(name => {
            ...
            return typescript_1.factory.createExpressionWithTypeArguments(
              typescript_1.factory.createIdentifier(
                (0, generate_1.toIdentifier)(extendedInterfaceName, true),
              ),
              undefined,
            );
          }),
...
exports.createIntefaceAliasDeclaration = createIntefaceAliasDeclaration;
...
function createFunctionDeclaration(
  name,
  { modifiers, asteriskToken, typeParameters, type },
  parameters,
  body,
) {
...
function createConstructor({ modifiers, parameters, body }) {
...
function createMethod(
  name,
  { modifiers, asteriskToken, questionToken, typeParameters, type } = {},
  parameters = [],
  body,
) {
...
function createParameter(
  name,
  { modifiers, dotDotDotToken, questionToken, type, initializer },
) {
...
function createIndexSignature(
  type,
  { modifiers, indexName = 'key', indexType = exports.keywordType.string } = {},
) {
...
function isValidIdentifier(str) {
  ...
  return (
    ...
    typescript_1.default.identifierToKeywordKind(node) === undefined
  );
}
